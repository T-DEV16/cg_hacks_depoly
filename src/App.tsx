    ...
    <div>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p>Join us as we bring BCIs to the mainstream and inspire impactful projects with AI.</p>
      ...
      <section className="eventInfo">
        <div className="container">
          ...
          <h3>August 30th - Pleasanton, CA</h3>
          <p>
            Join our community of innovators at CogniHacks 2025, a student-led hackathon bringing together coders,
            creators, and neurotech enthusiasts to explore the future of Brain-Computer Interfaces (BCIs). While BCIs
            have traditionally been used in clinical research, our mission is to mainstream their recreational and
            creative potential in the computer science world. By combining AI and HCI, our hackathon will inspire
            participants to build impactful, human-centered projects that push the boundaries of how we interact with
            technology.
          </p>
        </div>
      </section>
      ...
      <section id="tracks" className="container">
        ...
        <div className="benefits">
          <div className="benefit">
            ...
            <h3>BCI</h3>
            <p>
              Introduce/demonstrate Brain Computer Interfaces and its general data flow to attendees and provide
              resources for BCI powered projects.
            </p>
          </div>
          <div className="benefit">
            ...
            <p>
              Projects built via code aimed to enhance the way humans use computers/interfaces to solve tasks.
            </p>
          </div>
          <div className="benefit">
            ...
            <p>
              Idea-based projects that present better interfaces humans can use for solving tasks.
            </p>
          </div>
          <div className="benefit">
            ...
            <p>
              AI track focused on developing AI-powered Agents/LLMs to make this hot field even hotter!
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="sponsorship" className="container">
        ...
        <div className="frequently-asked-questions">
          <div className="sponsor-card">
            ...
            <p>
              Cognihacks is a hackathon focused on mainstreaming neurotechnology
          ...
          <div className="sponsor-card">
            ...
            <p>
              Anyone. High schoolers, Neurotech enthusiasts, College students, anyone who wants to
          ...
          <div className="sponsor-card">
            ...
            <p>
              No prior coding experience is required. We have a no code HCI track but even if you want to join a coding track you can join a team in these tracks, and we can help you find a team!
            </p>
          </div>
          <div className="sponsor-card">
            <h3>What should I bring to the hackathon?</h3>
            <p>
              Participants should bring laptop, charger, Emotiv's software (We will provide a instructions on how to install their software). We have free food and drinks!
            </p>
          </div>
          <div className="sponsor-card">
            <h3>Is there a cost to attend CogniHacks?</h3>
            <p>
              There is no cost because we have sponsors!
            </p>
          </div>
          <div className="sponsor-card">
            <h3>What is a BCI?</h3>
            <p>
              A Brain-Computer Interface (BCI) is a device that enables direct communication between your brain and a computer. Using sensors to detect brain signals,
          ...
          <div className="sponsor-card">
            ...
            <p>
              Nope! You don’t need to bring your own BCI to participate. We’ll have a limited number of BCI devices available on-site for teams to use during the hackathon. If you do have your own device (like a NextMind, OpenBCI, or Emotiv headset),
          ...
          <div className="sponsor-card">
            <h3>What is HCI?</h3>
            <p>
              Human-Computer Interaction (HCI) is the study and design of how people can better interact with computers and technology. It focuses on creating intuitive, efficient, and user-friendly interfaces —
      ...
      <section id="sponsorship" className="container">
        ...
        <div className="sponsorship-levels">
          <div className="sponsor-card">
            ...
            <p>
              During the hackathon, all updates, announcements, and essential resources will be posted on our live page.
              Whether it's schedule changes, API keys,
              important links, or project submission details, everything you need will be there.
            </p>
          </div>
        </div>
        <div className="sponsorship-levels">
